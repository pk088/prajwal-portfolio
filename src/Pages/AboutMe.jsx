        ...
        <div className="row aboutme">
          <div className="col-lg-9 col-11 mt-4 mx-auto">
            ...
            <div className="d-flex d-sm-flex flex-column flex-sm-column flex-lg-row justify-content-between  ">
              <div className="my-5 col-lg-8 col-sm-10 fs-3 order-2 order-lg-1">
                ...
                <div>
                  <ul className="my-lg-3">
                    <li>
                      MCA Post-Graduate from Sinhagad Institute of Management,
                      Pune with aggregate of 85.90%
                    </li>
                    <li>
                      BCA from Dr. Babasaheb Ambedkar Marathwada University with
                      aggregate of 64.20%.
                    </li>
                    <li>
                      HSC under Maharashtra state divisional board with 70%.
                    </li>
              ...
              <div className=" flex-wrap icons d-flex flex-lg-column justify-content-around h-705 order-1 order-lg-2 flex-sm-row">
                <a
                  ...
                  target="_blank"
                  href="https://www.linkedin.com/in/prajwal-kharat-4a0080206/"
                >
                ...
                <a
                  className="text-dark my-2"
                  target="_blank"
                  href="https://twitter.com/KharatPrajwal"
                >
                ...
                <a
                  className="text-dark my-2"
                  target="_blank"
                  href="https://www.facebook.com/prajwal.kharat.31"
                >
                ...
                <a
                  className="text-dark my-2"
                  target="_blank"
                  href="https://www.instagram.com/pkpatil_96k/"
                >
                ...
                <a
                  className="text-dark my-2"
                  target="_blank"
                  href="https://wa.me/918983996238?text=I%20want%20to%20connect.."
                >
            ...
            <div className="my-4 fs-3">
              ...
              <div>
                <p className="ms-4" style={{ textIndent: "50px" }}>
            ...
            <div className="my-4 fs-3">
              ...
              <div>
                <ul className="ms-3">
                  <li className="my-3">
                    <strong>Date of Birth:</strong> 15 DEC 1999
                  </li>
                  <li className="my-3">
                    <strong>Languages known:</strong> Marathi, Hindi and
                    English.{" "}
                  </li>
                  <li className="my-3">
                    <strong>Address:</strong> Near Chanakya Complex, Kacheri
                    Road, old Jalna.{" "}
                  </li>
                </ul>
              </div>
